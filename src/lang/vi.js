export default {
  route: {
    ...
    guide: 'Hướng dẫn',
    permission: 'Quyền',
    pagePermission: 'Quyền của trang',
    rolePermission: 'Quyền hạn vai trò',
    directivePermission: 'Giấy phép Chỉ thị',
    icons: 'Biểu tượng',
    components: 'Thành phần',
    tinymce: 'Soạn thảo Tinymce',
    markdown: 'Soạn thảo Markdown',
    ...
    menu2: 'Menu 2',
    Table: 'Dữ liệu Table',
    dynamicTable: 'Table động',
    dragTable: 'Table kéo thả',
